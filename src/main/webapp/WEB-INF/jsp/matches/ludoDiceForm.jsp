...
<ParchisYOca:layout pageName="LudoDiceForm">
    <h1>Please choose how you wanna play this turn</h1>

    <br>

    <form:form modelAttribute="respuesta" class="form-horizontal" id="ludo-dice-form">
