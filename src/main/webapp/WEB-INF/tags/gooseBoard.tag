...
<img id="0" src="../resources/images/RED.png" style="display:none">
<img id="1" src="../resources/images/GREEN.png" style="display:none">
<img id="2" src="../resources/images/BLUE.png" style="display:none">
<img id="3" src="../resources/images/YELLOW.png" style="display:none">
<script>
